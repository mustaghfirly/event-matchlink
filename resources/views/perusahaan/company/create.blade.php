...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100">
            <h2 class="text-lg font-semibold text-gray-900">Lengkapi Profil Perusahaan</h2>
        </div>
        <div class="p-6">
            <form method="POST" action="{{ route('perusahaan.company.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4"
                                  class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('deskripsi') border-red-300 @enderror">{{ old('deskripsi') }}</textarea>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="alamat" id="alamat" rows="3"
                                  class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('alamat') border-red-300 @enderror">{{ old('alamat') }}</textarea>
                ...
                <div class="mt-6 flex gap-3">
                    ...
                    <a href="{{ route('perusahaan.dashboard') }}" class="px-5 py-2.5 bg-gray-100 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-200 transition">Kembali</a>
                </div>
            </form>
        </div>
    </div>
